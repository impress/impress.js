...
(function ( document, window ) {
	...
	var chk = (function () {
		...
		return function ( prop, testProp, testVal ) {
			if ( typeof memory[ prop ] === "undefined" ) {

				if (arguments.length === 3) {
					var propPrefix = chk(testProp);
					style[ propPrefix ] = testVal;
					memory[ prop ] = style[propPrefix] !== '';
				} else {
	...
	// Is there at least support for 2D anim?
	chk('translate2d', 'transform', 'translate(0px, 0px)');
	...
	var translate = function ( t ) {
		return chk('translate3d') ? " translate3d(" + t.x + "px," + t.y + "px," + t.z + "px) " :
	...
	var rotate = function ( r, revert ) {
		var rX = " rotateX(" + r.x + "deg) ",
			rY = " rotateY(" + r.y + "deg) ",
			rZ = " rotateZ(" + r.z + "deg) ",
			ret = revert ? rZ+rY+rX : rX+rY+rZ;

		return chk('translate3d') ? ret : "rotate(" + r.z + "deg)" ;
	};
	...
	var impressSupported = ( chk("translate2d") !== null ) &&
