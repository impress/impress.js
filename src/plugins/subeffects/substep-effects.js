 ...
 *      
 *      When an object with class substep uses one of the following attributes, the value of these attributes indicate the css style to apply to a certain class. 
 *      In particular:
 * 
